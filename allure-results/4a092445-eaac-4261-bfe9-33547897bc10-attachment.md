...
- banner:
  - navigation:
    ...
    - button "Close":
      - img "Closing CTA"
      - text: Close
- heading "Checkbox Demo" [level=1]
- heading "Single Checkbox Demo" [level=2]
- checkbox "Click on check box"
- text: Click on check box
- heading "Disabled Checkbox Demo" [level=2]
- checkbox "Option 1"
- text: Option 1
- checkbox "Option 2"
- text: Option 2
...
- text: Option 3
- checkbox "Option 4" [disabled]
- text: Option 4
- heading "Multiple Checkbox Demo" [level=2]
- checkbox "Option 1"
- text: Option 1
- checkbox "Option 2"
- text: Option 2
...
- contentinfo:
  ...
  - list:
    ...
    - listitem:
      - link "Coding Jag - Issue 255":
        - /url: /newsletter/editions/issue255
    - listitem:
